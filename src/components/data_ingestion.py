...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df=pd.read_csv('notebook/data/nsl-kdd.csv')
...
if __name__=="__main__":
    ...
    transformation_data = DataTransformation()
    train_arr,test_arr,_ = transformation_data.initiate_data_transformation(train_data,test_data)
